...
import pandas as pd
from utils.loaded_embedding_models import get_loaded_embedding_models
from utils.vector_stores import get_existing_Vector_Stores
...
st.markdown("##### Oracle 23ai Similarity Search (Semantic Search) ")
st.markdown("Please select your vector store, search method, and enter your query \n\n To test different metrics create new vector stores with desired distance metrics")
...
with m1:
    ...
    similarity_search_method = st.radio(
            ...
            captions=[
                ...
                "Return docs most similar to query with relevance score",
